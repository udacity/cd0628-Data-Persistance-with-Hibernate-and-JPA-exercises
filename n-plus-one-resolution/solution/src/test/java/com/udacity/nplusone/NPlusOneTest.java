...
class NPlusOneTest {
    ...
    @Test
    void baseline_findAll_withBatchSizeAlsoBatches() {
        em.clear();
        statistics.clear();
        ...
        // With @BatchSize(20) on the entity, even findAll() batches.
        // Without @BatchSize, this would be 11 (1 + 10 N+1). The
        // @BatchSize fix protects ALL fetches, including unsuspecting ones.
